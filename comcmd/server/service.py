...
shared runtime. This is what makes Company Command a *backend* rather than a one-shot CLI:
...
from comcmd.pack import CompanyPack, build_runner, load_pack
...
class CompanyService:
    def __init__(self, settings: Settings, companies_dir: str | Path):
        ...
        if settings.durable:
            ...
            from comcmd.gateway.approvals import ApprovalStore
    ...
    def enroll_options(self, company: str, principal: str) -> dict:
        ...
        opts = webauthn.generate_registration_options(
            rp_id=self.settings.rp_id, rp_name="Company Command", user_name=principal)
