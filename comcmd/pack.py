...
from comcmd.gateway.verifier import ApprovalVerifier
from comcmd.kernel import make_ledger
from comcmd.kernel.executor import Executor, ToolHandler
...
def load_pack(directory: str | Path, *, trusted: bool = True) -> CompanyPack:
    ...
    if pack_py.exists():
        ...
        mod_name = f"comcmd_pack_{spec.metadata.name.replace('-', '_')}"
