...
presence flips Company Command to durable Postgres + DBOS execution. Nothing here logs or
prints secrets.
"""
...
class Settings:
    ...
    api_token: str | None = None         # bearer token for the HTTP control plane
    ...
    def from_env(cls, env: dict | None = None) -> "Settings":
        ...
        return cls(
            database_url=e.get("COMCMD_DATABASE_URL") or None,
            rp_id=e.get("COMCMD_RP_ID", "localhost"),
            rp_origin=e.get("COMCMD_RP_ORIGIN", "https://localhost"),
            model_url=e.get("COMCMD_MODEL_URL") or None,
            model_key=e.get("COMCMD_MODEL_KEY") or None,
            model_map=_model_map(e.get("COMCMD_MODEL_MAP")),
            ledger_url=e.get("COMCMD_LEDGER_URL") or None,
            api_token=e.get("COMCMD_API_TOKEN") or None,
        )
