...
Same contract as `acme.kernel.ledger.Ledger` (append / head_seal / read /
...
from acme.ids import canonical_json, digest
from acme.kernel.ledger import _GENESIS, SealedEvent
from acme.kernel.records import Event


class PostgresLedger:
    def __init__(self, dsn: str, *, table: str = "acme_events"):
        self._dsn = dsn
        self._table = table
