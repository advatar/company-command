"""Acme HTTP API — the backend surface of the engine.
...
from acme.pack import UntrustedPackError
...
def create_app(settings: Settings | None = None,
    ...
    import os
    companies_dir = companies_dir or os.environ.get("ACME_COMPANIES_DIR", "companies")
    service = CompanyService(settings, companies_dir)

    app = FastAPI(title="Acme", version="0.1.0",
