...
from acme.gateway.approvals import PendingApproval
from acme.gateway.enrollment import EnrolledCredential


class PgCredentialStore:
    def __init__(self, dsn: str, *, table: str = "acme_credentials"):
        self._table = table
